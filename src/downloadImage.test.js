...
describe('downloadImage', () => {
    ...
    function assertPath(p, expectedPath) {
        if (platform === 'win32') {
            expectedPath = expectedPath.replaceAll("/", "\\");
        }
        assert.equal(p, expectedPath);
    }
    ...
    it('should download an image and return its path', async () => {
        ...
        assertPath(p, 'cdn6.fiction.live/file/fictionlive/6dddb2ff-bdf2-418f-9a6d-710ca1c35acb.jpg');
    ...
    it('should detect file type and append the extension', async () => {
        ...
        assertPath(p, 'cdn6.fiction.live/file/fictionlive/447506bd-f804-4312-9f9e-726dc7daa745.jpeg.jpg');
